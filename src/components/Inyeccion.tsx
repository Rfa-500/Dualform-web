...
export const Inyeccion = () => {
  return (
    <section id="inyeccion" className="bg-white py-16 md:py-24 border-t border-black/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight mb-6">Moldeo por Inyección de Plástico</h2>
          ...
          <div className="order-1 lg:order-2 rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-black/5 shadow-2xl aspect-square bg-white p-8 md:p-12">
            <img 
